...
def find_possible_values(grid: tp.List[tp.List[str]], pos: tp.Tuple[int, int]) -> tp.Set[str]:
    ...
    # которые уже присутствуют в строке, столбце и блоке, в которых находится позиция pos.
...
def solve(grid: tp.List[tp.List[str]]) -> tp.List[tp.List[str]]:
    ...
    if pos is None:
        ...
        for i in values:
            ...
            # сли не найдено больше пустых позиций, это означает, что головоломка полностью решена, 
